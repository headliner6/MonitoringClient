...
namespace MonitoringClient.Model
{
    ...
    public partial class InventarisierungsloesungEntities : DbContext
    {
        ...
        public virtual IQueryable<Location> GetLocationsHirarchicalRecursive()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Location>("[InventarisierungsloesungEntities].[GetLocationsHirarchicalRecursive]()");
        }
    }
}
